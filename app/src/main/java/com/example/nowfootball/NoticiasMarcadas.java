...
public class NoticiasMarcadas extends Fragment {
    ...
    private FragmentNoticiasMarcadasBinding binding;


    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        return (binding = FragmentNoticiasMarcadasBinding.inflate(inflater, container, false)).getRoot();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        portadaNoticia1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                navController.navigate(R.id.noticia1);
            }
        });
        ...
        portadaNoticia2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                navController.navigate(R.id.noticia2);
            }
        });
