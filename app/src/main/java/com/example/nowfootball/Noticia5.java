...
import com.example.nowfootball.databinding.FragmentNoticia5Binding;

public class Noticia5 extends Fragment {
    View viewMencionSeleccion;
    View viewMencionjugador;

    NavController navController;

    private FragmentNoticia5Binding binding;


    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        return (binding = FragmentNoticia5Binding.inflate(inflater, container, false)).getRoot();
    }
