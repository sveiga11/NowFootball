...
import com.example.nowfootball.databinding.FragmentPartido3Binding;

import de.hdodenhof.circleimageview.CircleImageView;

public class Partido3 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        return (binding = FragmentPartido3Binding.inflate(inflater, container, false)).getRoot();
    }
