...
import com.example.nowfootball.databinding.FragmentPartido4Binding;

import de.hdodenhof.circleimageview.CircleImageView;

public class Partido4 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        return (binding = FragmentPartido4Binding.inflate(inflater, container, false)).getRoot();
    }
